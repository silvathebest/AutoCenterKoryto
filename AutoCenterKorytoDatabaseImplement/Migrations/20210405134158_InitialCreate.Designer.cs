...
namespace AutoCenterKorytoDatabaseImplement.Migrations
{
    ...
    [Migration("20210405134158_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoCenterKorytoDatabaseImplement.Models.Color", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AutoCenterKorytoDatabaseImplement.Models.Car", b =>
                {
                    b.HasOne("AutoCenterKorytoDatabaseImplement.Models.Color", "Color")
                        .WithMany("Car")
                        .HasForeignKey("ColorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AutoCenterKorytoDatabaseImplement.Models.Features", "Features")
                        .WithMany("Cars")
